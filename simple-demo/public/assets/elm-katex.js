const init =  async function(app) {
  ...
  katexJs.src = "https://cdn.jsdelivr.net/npm/katex@0.13.0/dist/katex.min.js"
...
function initKatex() {
  ...
  class MathText extends HTMLElement {
    ...
    connectedCallback() {
      ...
      link.setAttribute('href', 'https://cdn.jsdelivr.net/npm/katex@0.13.0/dist/katex.min.css');
