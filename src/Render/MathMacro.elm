module Render.MathMacro exposing
    ( MathMacroDict, evalList, evalMacro, newCommand2, parse, parseMany
    , evalStr, makeMacroDict
    )

{-| Expand run-time defined math-mode macros

@docs MathMacroDict, evalList, evalMacro, evalStr  makeMacroDict, newCommand2, parse, parseMany
